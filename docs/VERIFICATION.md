...
- 27 automated tests passed, including GraphSAGE propagation, strict temporal edges, simultaneous timestamps, neighbourhood caps, prefix-invariant predictions, training-only normalisation, independence from test labels and checkpoint round trips.
